...
namespace PrzezWymianePodtrasRuletka
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < ileRazy; i++)
            {
                ...
                string sciezka = "";
                Console.WriteLine("Przez wymiane podtras + ruletka wartosciowa");
                int[] roz = Ae();
                infoKoncowe[0] = "Przez wymiane podtras + ruletka wartosciowa";
