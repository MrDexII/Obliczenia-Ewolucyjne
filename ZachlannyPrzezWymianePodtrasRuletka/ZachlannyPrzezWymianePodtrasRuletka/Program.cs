...
namespace ZachlannyPrzezWymianePodtrasRuletka
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < ileRazy; i++)
            {
                ...
                string sciezka = "";
                Console.WriteLine("Zachlanny + Przez wymiane podtras + ruletka wartosciowa");
                int[] roz = Ae();
                infoKoncowe[0] = "Zachlanny + Przez wymiane podtras + ruletka wartosciowa";
